...
from app.modules.games.blackjack.multiplayer_service import get_table_state, process_ws_action
...
router = APIRouter(prefix="/blackjack-mp", tags=["Blackjack Multiplayer"])
